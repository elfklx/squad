...
tf.app.flags.DEFINE_boolean("run_train", False, "If set to false, make predictions without training the model")
tf.app.flags.DEFINE_boolean("isTest", True, "If set to false, use the test set")
...
class MyData(object):
    ...
    def __init__(self, isTest):
        ...
        if isTest:
            dev_q_ids = get_lines_from_file(pjoin(FLAGS.data_dir, "val.ids.question"))
            dev_c_ids = get_lines_from_file(pjoin(FLAGS.data_dir, "val.ids.context"))
            dev_span = get_lines_from_file(pjoin(FLAGS.data_dir, "val.span"))
            ...
            self.dev_answers = get_lines_from_file(pjoin(FLAGS.data_dir, "val.answer"), sentence=True)
        else:
